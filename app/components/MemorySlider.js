...
export default function MemorySlider() {
  ...
  <div className="relative z-10">
    ...
    <h2 className="text-center text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-pink-400 via-purple-400 to-yellow-300 text-transparent bg-clip-text mb-24">
      Just Her ✨ The Most Beautiful Chapter
    </h2>
        ...
        >
          {[...images, ...images].map((src, i) => (
            <motion.div
              ...
              whileHover={{ scale: 1.06 }}
              transition={{ type: "spring", stiffness: 200 }}
              className="relative min-w-[320px] h-[550px] rounded-3xl overflow-hidden shadow-2xl group backdrop-blur-sm"
            >
              {/* Glow Border */}
